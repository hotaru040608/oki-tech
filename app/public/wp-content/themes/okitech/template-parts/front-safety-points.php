...
<section class="py-16 md:py-24 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-4xl mx-auto grid md:grid-cols-3 gap-8 scroll-stagger">
            <!-- 初心者歓迎 -->
            <div class="text-center p-8 bg-white rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 scroll-fade-in">
                ...
                <h3 class="font-bold text-gray-900 mb-2"><?php _e('初心者歓迎', 'okitech'); ?></h3>
            ...
            <div class="text-center p-8 bg-white rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 scroll-fade-in">
                ...
                <h3 class="font-bold text-gray-900 mb-2"><?php _e('どこからでも参加OK', 'okitech'); ?></h3>
            ...
            <div class="text-center p-8 bg-white rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 scroll-fade-in">
                ...
                <h3 class="font-bold text-gray-900 mb-2"><?php _e('無料で始められる', 'okitech'); ?></h3>
